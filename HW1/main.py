...
def run_experiment():
    ...
    algorithms = [
        (
            "BFS",
            bfs_shortest_path,
            lambda m, s, g: bfs_shortest_path(m.graph, s, g),
            False,
        ),
        ...
        (
            "Greedy (Lower)",
            greedy_search,
            lambda m, s, g: greedy_search(m, s, g, "lower"),
            True,
        ),
        (
            "Greedy (Upper)",
            greedy_search,
            lambda m, s, g: greedy_search(m, s, g, "upper"),
            True,
        ),
        (
            "A* (Lower)",
            a_star_search,
            lambda m, s, g: a_star_search(m, s, g, "lower"),
            True,
        ),
        (
            "A* (Upper)",
            a_star_search,
            lambda m, s, g: a_star_search(m, s, g, "upper"),
            True,
        ),
    ]
    ...
    print(
        f"{'Test Case':<25} {'Algorithm':<20} {'Success':<8} {'Cost':<6} {'Nodes':<6} {'Time(ms)':<10} {'Path'}"
    )
    print("-" * 120)
    ...
    for start, goal in test_cases:
        ...
        for algo_name, func, wrapper, is_heuristic in algorithms:
            ...
            # 2. Timing run (100 loops for better precision on small graphs)
            ...
            print(
                f"{test_case_name:<25} {algo_name:<20} {success:<8} {cost:<6} {nodes_expanded:<6} {avg_time_ms:<10.4f} {path_str}"
            )
